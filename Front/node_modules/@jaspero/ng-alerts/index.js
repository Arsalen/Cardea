import { Component, ComponentFactoryResolver, EventEmitter, HostBinding, Injectable, Injector, Input, NgModule, NgZone, Output, TemplateRef, ViewChild, ViewContainerRef } from '@angular/core';
...
var AlertComponent = (function () {
    ...
    AlertComponent.propDecorators = {
        "close": [{ type: Output },],
        "type": [{ type: HostBinding, args: ['class',] },],
    };
...
var AlertsComponent = (function () {
    ...
    function () {
        ...
        this._listener = this._service.alert$.subscribe(function (alert) {
            ...
            var /** @type {?} */ injector = Injector.create([], _this.compViewContainerRef.parentInjector);
...
export { JasperoAlertsModule, AlertsComponent, AlertComponent, AlertsService };
